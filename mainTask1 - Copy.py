...
for affect in affect_list:
  ...
  for train_part in [train_data]:
    ...
    for idd in test_data[affect]:
        ...
        test_x[0].append(tmp)
        test_y[0].append(float(train_tweet_json['magnitude']))
        ...
        test_x[1].append(tmp)
        test_y[1].append(float(train_tweet_json['magnitude']))
        ...
        test_x[2].append(tmp)
        test_y[2].append(float(train_tweet_json['magnitude']))
        ...
        test_x[3].append(tmp)
        test_y[3].append(float(train_tweet_json['magnitude']))
        ...
        test_x[4].append(tmp)
        test_y[4].append(float(train_tweet_json['magnitude']))
        ...
        test_x[5].append(tmp)
        test_y[5].append(float(train_tweet_json['magnitude']))
        ...
        test_x[6].append(tmp)
        test_y[6].append(float(train_tweet_json['magnitude']))
        ...
        test_x[7].append(tmp)
        test_y[7].append(float(train_tweet_json['magnitude']))
        ...
        test_x[8].append(tmp)
        test_y[8].append(float(train_tweet_json['magnitude']))
        ...
        test_x[9].append(tmp)
        test_y[9].append(float(train_tweet_json['magnitude']))
        ...
        test_y[10].append(float(train_tweet_json['magnitude']))
        ...
        test_y[11].append(float(train_tweet_json['magnitude']))
    ...
    for idd in test_data[affect]:
        ...
        iiii += 1
    f_prediction = open(os.path.join(cwd, 'dataset', 'task1', 'submission', 'EI-reg_en_' + affect + '_pred.txt'), 'w+')
